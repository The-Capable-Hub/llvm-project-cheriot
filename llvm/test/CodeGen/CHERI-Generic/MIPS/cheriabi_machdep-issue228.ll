...
; RUN: llc -mtriple=mips64 -mcpu=cheri128 -mattr=+cheri128 --relocation-model=pic -target-abi n64 -O2 -verify-machineinstrs -relocation-model=static %s -o - | FileCheck %s
