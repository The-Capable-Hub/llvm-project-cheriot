; DO NOT EDIT -- This file was generated from test/CodeGen/CHERI-Generic/Inputs/csetbounds-stats-function.ll
...
; RUN: rm -f %t.csv
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+xcheri,+xcheripurecap,+f,+d %s -O0 -o /dev/null -filetype=obj \
