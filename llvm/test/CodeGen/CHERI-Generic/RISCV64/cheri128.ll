...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+xcheri,+f,+d -O2 -verify-machineinstrs %s -o - | FileCheck %s
...
; CHECK-NEXT:    ld a1, %pcrel_lo(.Lpcrel_hi0)(a1)
