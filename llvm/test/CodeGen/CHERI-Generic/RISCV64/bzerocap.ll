...
; PURECAP:       # %bb.0: # %entry
; PURECAP-NEXT:    csd zero, 56(a0)
; PURECAP-NEXT:    csd zero, 48(a0)
; PURECAP-NEXT:    csd zero, 40(a0)
; PURECAP-NEXT:    csd zero, 32(a0)
; PURECAP-NEXT:    csd zero, 24(a0)
; PURECAP-NEXT:    csd zero, 16(a0)
; PURECAP-NEXT:    csd zero, 8(a0)
; PURECAP-NEXT:    csd zero, 0(a0)
; PURECAP-NEXT:    cret
entry:
