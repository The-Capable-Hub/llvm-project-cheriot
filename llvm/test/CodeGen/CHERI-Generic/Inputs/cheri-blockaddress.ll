...
@IF-MIPS@; RUN:   FileCheck %s --check-prefix=OBJ '-DCAP_RELOC=R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE' -DADDEND=0x1C
@IF-RISCV@; RUN:   FileCheck %s --check-prefix=OBJ -DCAP_RELOC=R_RISCV_CHERI_CAPABILITY_CODE -DADDEND=0x18
...
; ASM-NEXT:    .chericap
; ASM-NEXT:    .size addrof_label_in_static.b, @CAP_BYTES@
