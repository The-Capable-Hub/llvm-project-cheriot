...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+xcheri,+xcheripurecap,+f -verify-machineinstrs < %s | FileCheck %s --check-prefix=PURECAP
;; Hybrid baseline to compare against
; RUN: sed 's/addrspace(200)//g' %s | llc -mtriple=riscv32 --relocation-model=pic -target-abi ilp32f -mattr=+xcheri,+f -verify-machineinstrs | FileCheck %s --check-prefix=HYBRID
...
; HYBRID-NEXT:    lw a1, %pcrel_lo(.Lpcrel_hi0)(a1)
; HYBRID-NEXT:    li a2, 3
; HYBRID-NEXT:    li a3, 0
...
; HYBRID-NEXT:    auipc a1, %got_pcrel_hi(maskp)
; HYBRID-NEXT:    lw a1, %pcrel_lo(.Lpcrel_hi1)(a1)
; HYBRID-NEXT:    li a2, 3
; HYBRID-NEXT:    li a3, 0
; HYBRID-NEXT:    call au_preselect
; HYBRID-NEXT:    li a0, 0
