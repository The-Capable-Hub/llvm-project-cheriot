...
; RUN: rm -f %t.csv
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+xcheri,+xcheripurecap,+f %s -O0 -o /dev/null \
...
@alloc_fn_ptr = addrspace(200) global ptr addrspace(200) null, align 8
...
entry:
  %0 = load ptr addrspace(200), ptr addrspace(200) @alloc_fn_ptr, align 8
