...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+xcheri,+xcheripurecap,+f -cheri-cap-table-abi=pcrel %s -o - | FileCheck %s
...
; CHECK-NEXT:    .size global_fn_ptr, 8
